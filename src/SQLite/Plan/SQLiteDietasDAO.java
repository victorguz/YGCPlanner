...
public class SQLiteDietasDAO implements DAO.plan.PlanDAO {
    ...
    public void eliminar(Plan a) throws DAOException {
        ...
        try {
            ...
            if (s.executeUpdate() == 0) {
                throw new DAOException("Error al eliminar plan de alimentación");
            }
        } catch (SQLException ex) {
            throw new DAOException(ex);
        } finally {
    ...
    public Plan convertir(ResultSet rs) throws DAOException {
        if (rs == null) {
            throw new DAOException("Error al convertir plan de alimentación");
        }
        try {
            Plan c = new Plan();
